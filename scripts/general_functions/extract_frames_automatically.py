...
def extract_frames_video_auto(path_images_folder, extracted_frames_dir, output_dir_edges, output_dir_croped):
...
def main(_argv):
    ...
    extract_frames_video_auto(video_path, extracted_frames_dir, save_dir=save_dir)
